---
name: pptx
description: "Usa esta skill cada vez que haya un archivo .pptx de por medio, sea para crear, leer, extraer texto, editar o combinar presentaciones, plantillas, layouts, notas o comentarios. (pptx, deck, slides, presentation)"
...
- Arial en todo el deck (titulos bold, cuerpo regular).
- Portada: titulo 32-40pt bold, subtitulo 20-24pt.
- Contenido: titulo slide 28-32pt, cuerpo 14-16pt, captions 10-12pt gris.

Portada obligatoria:

1. Titulo del trabajo (32-40pt, bold).
2. Integrantes (nombre + apellido, 14-16pt).
3. Asignatura, seccion, docente y fecha.

Layout contenido:

- 2 columnas: texto izquierda, imagen/grafico/icono derecha.
- Un elemento visual por slide (imagen, tabla o icono en circulo rojo).
- Stat callouts: numero grande 60-72pt en rojo `#ed1c24` + etiqueta pequeña gris debajo.

Checklist QA obligatorio antes de entregar (Windows, 8 lineas):

- [ ] 1) `python -m markitdown salida.pptx` legible: contenido completo, sin typos, orden correcto.
- [ ] 2) `python -m markitdown salida.pptx | findstr /I "lorem xxxx TODO"` sin resultados; si aparecen, corregir antes de entregar.
- [ ] 3) Sin slides vacias ni solo-titulo: cada slide con titulo + contenido.
- [ ] 4) Paleta INACAP si es para la U: rojo `#ed1c24` / negro `#231f20` / gris `#404040` / blanco; prohibido azul generico.
- [ ] 5) Portada INACAP completa: titulo + integrantes + asignatura, seccion, docente y fecha.
