---
name: buen-gusto-diseno
description: "Generación de archivos DESIGN.md para Google Stitch con estándares premium de tipografía, color, layout y movimiento. (DESIGN.md, design system, Stitch)"
allowed-tools:
  - "StitchMCP"
  - "Read"
  - "Write"
