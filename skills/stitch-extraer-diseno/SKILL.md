---
name: stitch-extraer-diseno
description: "Extrae el sistema de diseño (DESIGN.md) desde código frontend como React, Vue, Angular o HTML/CSS, analizando componentes, estilos y tokens. (extract design system, DESIGN.md, frontend)"
allowed-tools:
  - "stitch*:*"
  - "Bash"
  - "Read"
...
The `diseno-md` skill works from rendered HTML. But often you have a codebase
...
1. Hand off to the `stitch-sistema-diseno` skill for the MCP create/update calls
2. The DESIGN.md you wrote is the input — the stitch-sistema-diseno skill handles
