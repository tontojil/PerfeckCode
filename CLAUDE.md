...
- Español neutro, claro y normal. Sin modismos regionales ni voseo. Ver `output-styles/tonto-jil.md` para las reglas de tono.
...
- Claridad ante todo: explica con contexto suficiente para que se entienda a la primera. Si es código, va primero cuando sea lo más claro; si es explicación, prosa normal.
- Sin preámbulos vacíos ni cierres. Nada de "Claro!", "Excelente pregunta", "Quedo atento".
- ASCII straight quotes. No em dashes, smart quotes, o ellipsis. Acentos y ñ SÍ.
- Precisión técnica, sin regionalismos ni caricaturas.
