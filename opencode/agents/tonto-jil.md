...
3. Delegue con @ a los subagentes de C:/Users/Pablo/.config/opencode/agents/
   según la tabla de AGENTS.md. Para bugs use @depurador, para review
   @revisor-codigo, para trabajos académicos @redactor-tecnico con skills inacap/pptx/xlsx.
